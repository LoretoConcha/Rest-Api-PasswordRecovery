...
public final class ResourcesConfig {
	 ...
	 */
	private static final String LOG4J_FILE_NAME = "RecoverPassword-log4j.properties";

	/**
	 * Nombre del archivo con la configuracion propia de la aplicacion
	 */
	private static final String RESOURCE_FILE_NAME = "RecoverPassword-resource.properties";
	...
	public static void config() {
		...
		try {
			...
			throw new NotInitResourceException("Error al cargar el archivo properties: " + e, e);
		}
	}
